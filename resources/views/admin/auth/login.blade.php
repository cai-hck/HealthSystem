...
<div class="logo-section valign-wrapper circle primary-bg">
    <img class="valign" src="{{ asset('/logo/ic_whatshot_48px.svg')}}" alt="Forge">
</div> 
<div class="signin-wrapper auth-wrap"   style="background: white;border: black 1px solid;">
        ...
        <div class="row">
            <form class="col s12" role="form" method="POST" action="{{ url('/admin/login') }}">
                ...
                <div class="row">
                    ...
                    <div class="col s12 center nav-link"><a class="switchVisibility" href="{{ url('/admin/register') }}" data-ref="signup-wrapper">Create account</a></div>
                </div>
            </form>
        </div>
    </div>
