...
/* me */
 Route::post('/addpatient','Admin\HomeController@addpatient');
 Route::get('/delpatient/{id}', 'Admin\HomeController@delpatient');
 Route::get('/clinicalpatient/{id}', 'Admin\HomeController@clinicalpatient');
 
Route::post('/sendpatientexcel','Admin\HomeController@sendpatientexcel');
Route::post('/updateclinicalpatient','Admin\HomeController@updateclinicalpatient');